...
>
  <div class="relative">
    ...
    <div class="relative z-10 pt-3 pb-7 sm:pt-4 sm:pb-8 lg:pt-5 lg:pb-12">
      <div
        class="grid gap-8 lg:grid-cols-[minmax(0,22rem)_minmax(0,1fr)] lg:items-stretch lg:gap-12"
      >
