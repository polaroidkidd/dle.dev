...
const WelcomeMessage: React.FC = () => {
  return (
    <>
      <section>
        <h2 className="heading-secondary welcome-message">Hi! I'm Daniel Einars.</h2>
        ...
        <h4 className="heading-quaternary u-center-text__horizontal">
          Check out my <NavLink to={ROUTES.BLOG}>first blog entry</NavLink> on using React with
          Typescript!
        </h4>
      </section>
    </>
